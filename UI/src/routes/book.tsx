...
export const Route = createFileRoute("/book")({
  head: () => ({
    meta: [
      { title: "Book Service — L Mills LLC" },
      { name: "description", content: "Book lawncare and yard care in Escondido and the North County valley. Free quote within 24 hours." },
      { property: "og:title", content: "Book Service — L Mills LLC" },
      { property: "og:description", content: "Free consultations within 24 hours." },
    ],
  }),
  component: BookPage,
});
        ...
        <section className="border-b border-primary/10 bg-gradient-to-b from-secondary/40 to-transparent py-16 md:py-24">
          <div className="mx-auto max-w-7xl px-6">
            ...
            <p className="mt-4 max-w-2xl text-lg text-muted-foreground">
              Fill out the form and we'll schedule a walk-through and send a tailored quote. Weekly service typically starts within a few days.
            </p>
          </div>
        </section>
                  ...
                  <div className="mt-5 grid gap-5 sm:grid-cols-2">
                    <div>
                      ...
                      <select name="service" required className="mt-1.5 w-full rounded-xl border border-primary/15 bg-background px-4 py-3 text-sm outline-none transition focus:border-primary focus:ring-2 focus:ring-primary/20">
                        ...
                        <option>Estate Mowing</option>
                        <option>Precision Edging</option>
                        <option>Seasonal Fertilization</option>
                        <option>Hedge & Shrub Care</option>
                        <option>Leaf Clean-Up</option>
                        <option>Aeration & Overseed</option>
                        <option>Coastal Landscape Care</option>
