...
export const Route = createFileRoute("/contact")({
  head: () => ({
    meta: [
      { title: "Contact — L Mills LLC" },
      { name: "description", content: "Get in touch with L Mills LLC in Escondido and the North County valley. Call +1 619 988 0715 or send us a message." },
      { property: "og:title", content: "Contact — L Mills LLC" },
      { property: "og:description", content: "Reach our team in Escondido and the North County valley." },
    ],
  }),
